...
const md = `
Ethics refers to standards of behavior that tell us how human beings ought to act in the many situations in which they find themselves - as citizens, teachers, professionals, researchers, friends, and so on, in order to be socially responsible. These standards are explained by ethical theories. Daily, each of us is faced with situations that require us to make a decision, and determine what the ethical course of action entails. This section will walk you through common principles of social responsibility and research ethics, as well as outline a framework for making an ethical decision.
...
Adapted from: [A Framework for Making Ethical Decisions](https://www.brown.edu/academics/science-and-technology-studies/framework-making-ethical-decisions)
...
_Adapted from Shamoo A and Resnik D. 2009. Responsible Conduct of Research, 2nd ed. (New York: Oxford University Press)._
...
- Consider each ethical principle
- Deliberate on wether the rules are met

#### Ethical decisions may...

- Involve conflict among principles
- Require a balancing of conflicting principles
- Be both principle-based and case-based
- Involve a systematic analysis of all principles
...
**Source:**
- Amy Harmon, "Students Learning Media Files," The New York Times, November 27, 2002, Section C.
- Rebecca Trounson, "Pirated Files Clog College Networks," Los Angeles Times, December 2, 2002, p. 1
...
const questions = [
  {
    id: 1,
    question:
      'Imagine that you are the head of a committee appointed to develop a policy on this issue. You have done some soul-searching and realize that you are basically a Utilitarian. What position would you likely take?',
    options: [
      {
        id: 'a',
        label: 'The university should do the virtuous thing and protect the rights of the artists.',
      },
      {
        id: 'b',
        label:
          "An individual's rights to listen to any tune outweighs the interests of the university and other students.",
      },
      { id: 'c', label: 'Societal rules that protect an artist are of paramount importance.' },
      {
        id: 'd',
        label:
          'Since there are more student than others on our campus, their need to download outweighs any other interests.',
      },
    ],
    answer: 'd',
  },
...
const s1Ethics = { md, questions };

export default s1Ethics;
